...
return {
  ...
  event = { "bufreadpre " .. vim.fn.expand "~" .. "/Library/Mobile Documents/iCloud~md~obsidian/Documents/work/**.md" },
  ...
  opts = function(_, opts)
    ...
    return astrocore.extend_tbl(opts, {
      workspaces = {
        {
          path = vim.env.HOME .. "/Library/Mobile Documents/iCloud~md~obsidian/Documents/work", -- specify the vault location. no need to call 'vim.fn.expand' here
        },
      },
      open = {
